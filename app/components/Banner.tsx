      ...
      <div className="container mx-auto max-w-6xl">
        <div className="flex flex-col lg:flex-row items-center ">
          ...
          <div className="flex justify-center lg:justify-end relative w-full lg:w-auto">
            <div className="relative top-10">
                ...
                <div className="relative inline-block ">
                  ...
                  <div className="relative">
                    <p className="text-white text-lg whitespace-nowrap">
                      Olá! Eu sou{" "}
                      <span className="text-purple-400">Thiogo Gambeta</span>
                    </p>
                  </div>
              ...
              <Image
                src="/assets/me.png"
                alt="Thiogo Gambeta - Software Engineer"
                width={300}
                height={300}
          ...
          <div className="flex-1 space-y-6 text-center lg:text-left">
            ...
            <div className="">
              <p className="text-2xl"> Um Desenvolvedor de Software que </p>
              ...
              <p className="text-md text-white/80">
                Porque, se a primeira impressão não convence, o que convencerá?
              </p>
            </div>
          </div>
        </div>
        <div className="space-y-3 pt-15 text-center lg:text-left">
          ...
          <p className="text-lg lg:text-xl text-white/90 tracking-wide flex flex-wrap items-center justify-center lg:justify-start gap-2">
            <span>Atualmente, Sou Estagiário de Desenvolvimento de Software na</span>
            <span className="flex items-center gap-2">
              <a href="https://www.uniplast.com.br/" target="_blank" rel="noopener noreferrer">
                <Image src="/assets/logo-uniplast.png" alt="Uniplast" width={20} height={20} className="w-5 h-5" style={{ width: "35px", height: "20px" }} />
              </a>
              <span className="text-blue-400 font-semibold"><a href="https://www.uniplast.com.br/" target="_blank" rel="noopener noreferrer">Uniplast,</a></span>
            </span>
          </p>
