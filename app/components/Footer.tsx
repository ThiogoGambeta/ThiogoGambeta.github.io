      ...
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12">
          ...
          <p className="text-md text-white/80 max-w-2xl mx-auto mb-8">
            Estou sempre em busca de novos desafios para criar soluções escaláveis, eficientes e que gerem impacto real.
          </p>
          <a
            href="mailto:thiogogambeta@gmail.com"
            className="text-md text-purple-400 hover:text-purple-300 transition-colors"
          >
            thiogogambeta@gmail.com
          </a>
        </div>
        ...
        <div className="flex justify-center gap-6 mt-12">
          <Link
            href="https://www.instagram.com/thgambeta/"
            target="_blank"
          ...
          <Link
            href="https://github.com/ThiogoGambeta"
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 border border-purple-500/30 hover:border-purple-500/50 transition-all"
            aria-label="GitHub"
          ...
          <Link
            href="https://www.linkedin.com/in/thiogogambeta/"
            target="_blank"
            rel="noopener noreferrer"
            className="w-10 h-10 flex items-center justify-center rounded-full bg-white/10 hover:bg-white/20 border border-purple-500/30 hover:border-purple-500/50 transition-all"
            aria-label="LinkedIn"
        ...
        <div className="text-center mt-12 pt-8 border-t border-white/10">
          <p className="text-white/60 text-sm">
            © {new Date().getFullYear()} Thiogo Gambeta. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
